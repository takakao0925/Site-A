//(function(){
	var AMOUNT=200, d=25, R=200, adjustment=true, adaptive=true,
		...
		canvas='#earth', color='#420236', fogC='#0D1D28', T_earth='https://mapplix.github.io/earth/earth.png';
...
\			');
	...
	var Omaterial = new THREE.MeshBasicMaterial({color:'#155775'});
	var Ocean = new THREE.Mesh(new THREE.IcosahedronGeometry(R*.76, 3), Omaterial);
	var wGeometry=geometry.clone();
	particles = new THREE.Group();
	world = new THREE.Group();
	var Net=new THREE.Mesh(bGeometry, Wmaterial);
	particles.add(Net, Ocean, Earth);//new THREE.Points(geometry, Pmaterial),
